...
class Form {
     ...
     * @param formEmail {String} 
     */
    constructor(formName, formEmail) { 
        
        Form.initialize(this, formName, formEmail);
    }
     ...
     */
    static initialize(obj, formName, formEmail) { 
        obj['formName'] = formName;
        obj['formEmail'] = formEmail;
    }
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('formEmail')) {
                obj['formEmail'] = ApiClient.convertToType(data['formEmail'], 'String');
            }
        }
        return obj;
    }
...
/**
 * @member {String} formEmail
 */
Form.prototype['formEmail'] = undefined;
